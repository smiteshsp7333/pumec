            ...
            ->components([
                Section::make('Core Details')
                    ->schema([
                        ...
                        \Filament\Forms\Components\FileUpload::make('banner_image')- Banner Background Image')-, TextInput::make('hero_subtitle')->label('Hero Subtitle / Description')->columnSpanFull(),
