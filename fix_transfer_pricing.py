...
os.makedirs('c:/Users/smite/OneDrive/Desktop/client1/src/app/services/transfer-pricing', exist_ok=True)
...
with open('c:/Users/smite/OneDrive/Desktop/client1/src/app/services/transfer-pricing/page.tsx', 'w', encoding='utf-8') as f:
    f.write(code)
print('Done writing transfer-pricing page.tsx')
