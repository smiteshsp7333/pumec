...
os.makedirs('c:/Users/smite/OneDrive/Desktop/client1/src/app/services/corporate-transaction', exist_ok=True)
os.makedirs('c:/Users/smite/OneDrive/Desktop/client1/src/app/services/litigation-dispute', exist_ok=True)

# ==========================================
# PAGE 1: Corporate & Transaction Advisory
# ==========================================
code_corporate = """import { Metadata } from 'next';
...
with open('c:/Users/smite/OneDrive/Desktop/client1/src/app/services/corporate-transaction/page.tsx', 'w', encoding='utf-8') as f:
    f.write(code_corporate)
print('Done writing corporate-transaction page.tsx')

# ==========================================
# PAGE 2: Litigation & Dispute Resolution
# ==========================================
code_litigation = """import { Metadata } from 'next';
import Link from 'next/link';
...
with open('c:/Users/smite/OneDrive/Desktop/client1/src/app/services/litigation-dispute/page.tsx', 'w', encoding='utf-8') as f:
    f.write(code_litigation)
print('Done writing litigation-dispute page.tsx')
