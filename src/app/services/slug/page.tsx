          ...
          <div className="grid md:grid-cols-3 gap-10">
            {service.offerings.map((o, i) => (
              ...
              >
                ...
                <p className="text-slate-600 text-sm leading-relaxed group-hover:text-white/70 transition-colors">
                  {o.desc}
                </p>
              </motion.div>
            ))}
        ...
        <AnimatedSection className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {service.faqs.map((faq) => (
              <div key={faq.q} className="p-8 rounded-2xl bg-slate-100 border border-slate-200">
                <h4 className="text-slate-900 font-bold text-lg mb-3">Q: {faq.q}</h4>
