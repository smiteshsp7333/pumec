...
const services = [
  {
    ...
    desc: "Statutory, internal, and forensic audits conducted with meticulous precision ensuring regulatory compliance and stakeholder confidence.",
    featured: false,
  },
  {
    id: "taxation",
    ...
    desc: "Comprehensive direct & indirect tax planning, GST compliance, ITR filing, and strategic advisory to minimise your tax burden legally.",
    featured: true,
  },
  {
    id: "nri",
    ...
    desc: "FEMA compliance, repatriation advisory, NRI tax returns, DTAA benefits, and cross-border investment structuring for global Indians.",
    featured: false,
  },
  {
    id: "corporate",
    ...
    desc: "End-to-end company incorporation, LLP formation, ROC filings, and regulatory structuring for startups and established enterprises.",
    featured: false,
  },
  {
    id: "consulting",
    ...
    desc: "Strategic business planning, financial modelling, performance improvement, and operational excellence consulting for growth-stage companies.",
    featured: false,
  },
  {
    id: "mergers",
    ...
    desc: "Due diligence, valuation, deal structuring, and post-merger integration advisory for seamless corporate transactions.",
    featured: false,
  },
];
