              ...
              <div className="relative w-full aspect-[4/3] overflow-hidden bg-black/5">
                <img 
                  src={p.image && p.image.trim() !== '' 
                    ? (p.image.startsWith('http') || p.image.startsWith('/') ? p.image : `http://127.0.0.1:8000/storage/${p.image}`) 
                    : [
                        "https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", // Taxation
                        "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", // Advisor
                        "https://images.unsplash.com/photo-1507679799987-c73779587ccf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"  // Global
                      ][i % 3]}
                  alt={p.title} 
                  ...
                  onError={(e) => {
                    ...
                    const fallbacks = [
                      "https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", // Taxation / Finance
                      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", // Business Advisory
                      "https://images.unsplash.com/photo-1507679799987-c73779587ccf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"  // Global / Corporate
                    ];
